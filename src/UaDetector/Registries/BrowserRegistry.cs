...
public static class BrowserRegistry
{
    ...
    internal static readonly FrozenDictionary<BrowserCode, string> BrowserCodeMappings =
        new Dictionary<BrowserCode, string>
        {
            ...
            { BrowserCode.ChatGptAtlas, BrowserNames.ChatGptAtlas },
            { BrowserCode.Ace, BrowserNames.Ace },
            { BrowserCode.AnonyvBrowser, BrowserNames.AnonyvBrowser },
            { BrowserCode.ArtisBrowser, BrowserNames.ArtisBrowser },
            { BrowserCode.AskBrowser, BrowserNames.AskBrowser },
            { BrowserCode.BlackBrowser, BrowserNames.BlackBrowser },
            { BrowserCode.BrowseSafe, BrowserNames.BrowseSafe },
            { BrowserCode.ClearTvBrowser, BrowserNames.ClearTvBrowser },
            { BrowserCode.DduBrowser, BrowserNames.DduBrowser },
            { BrowserCode.Doubao, BrowserNames.Doubao },
            { BrowserCode.Ifbrowser, BrowserNames.Ifbrowser },
            { BrowserCode.LemurBrowser, BrowserNames.LemurBrowser },
            { BrowserCode.NeuroBrowser, BrowserNames.NeuroBrowser },
            { BrowserCode.OperaAir, BrowserNames.OperaAir },
            { BrowserCode.PandaBrowser, BrowserNames.PandaBrowser },
            { BrowserCode.PowerBrowser, BrowserNames.PowerBrowser },
            { BrowserCode.Ray, BrowserNames.Ray },
            { BrowserCode.Seekee, BrowserNames.Seekee },
            { BrowserCode.SnapBrowser, BrowserNames.SnapBrowser },
            { BrowserCode.StayBrowser, BrowserNames.StayBrowser },
            { BrowserCode.TincatBrowser, BrowserNames.TincatBrowser },
            ...
            { BrowserCode.Blazer, BrowserNames.Blazer },
            ...
            { BrowserCode.SpeedBrowser360, BrowserNames.SpeedBrowser360 },
            { BrowserCode.MullvadBrowser, BrowserNames.MullvadBrowser },
            { BrowserCode.Stadium, BrowserNames.Stadium },
            { BrowserCode.TeakBrowser, BrowserNames.TeakBrowser },
        }.ToFrozenDictionary();
